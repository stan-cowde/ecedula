...
@section('main')
    <main id="maintwo" class="maintwo">
        ...
        <section class="section profile h-50 w-75 text-center">
            <div class="mb-3">
            ...
            <div>
                ...
                <p>Transaction Name: <strong>{{ $name }}</strong></p>
                <p>Transaction Amount: <strong>{{ number_format(($amount / 100), 2) }}</strong></p>
            </div>
        </section>
