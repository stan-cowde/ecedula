    ...
    @section('main')
        <main id="maintwo" class="maintwo">
            ...
            <div class="container h-auto">
                ...
                @if(intval($step) === 1)
                    @livewire('user.verification.first-step', [intval($step)])
                @elseif(intval($step) === 2)
                    @livewire('user.verification.second-step', [intval($step)])
                @elseif(intval($step) === 3)
                    @livewire('user.verification.third-step', [intval($step)])
                @elseif(intval($step) === 4)
                    @livewire('user.verification.fourth-step', [intval($step)])
                @endif
