            ...
            <div class="p-5">
              <div class="text-center">
                ...
                <form class="user" action="logincode.php" method="POST">
                    ...
                    <input type="text" name="Firts Name" class="form-control form-control-user" placeholder="Enter First Name">
                    </div>
                    <div class="form-group">
                    <input type="text" name="Last Name" class="form-control form-control-user" placeholder="Enter Last Name">
                    </div>
