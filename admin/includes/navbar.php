...
<li class="nav-item">
  ...
  <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <a class="collapse-item" href="approved-users.php">Approved</a>
      <a class="collapse-item" href="disapproved-users.php">Dissaproved</a>
      <div class="collapse-divider"></div>

<li class="nav-item">
  <a class="nav-link" href="accounts-table.php">
  <i class="fas fa-fw fa-folder"></i>
    <span>Account Credentials </span></a>
</li>
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  ...
                  <div>
                    <div class="small text-gray-500">Feature Soon</div>
                    <span class="font-weight-bold">This feature will be available soon.</span>
                  </div>
                </a>
