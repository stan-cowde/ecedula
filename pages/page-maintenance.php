...
<body>
    ...
    <div class="grid-container">
        <img src="../assets/img/under-construction.png" id="thumbs-up">
        <h3>Under Construction</h3>
            <p class="semi-qoute">
            This is down right now for updates & maintenance. Please try again tomorrow! It should be back up then.
            </p>
    </div>
